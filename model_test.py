...
def test_cnn():
    # 加载数据
    train_ds, test_ds, class_names = data_load("C:/Users/Administrator.DESKTOP-30KLKF0/Desktop/Tianchi/new_data/train",
                                               "C:/Users/Administrator.DESKTOP-30KLKF0/Desktop/Tianchi/new_data/test", 224, 224, 16)
    # 加载模型
    model = tf.keras.models.load_model("models/cnn_plant_disease.h5")
    # model.summary()
    # 测试
